...
import { ConversationDto, ConversationMessageDto } from './dto/support-chat.dto';
...
export class SupportChatController {
  ...
  @Get('conversations')
  @ApiOkResponse({ type: [ConversationDto], description: 'List of all conversations' })
  ...
  @ApiOkResponse({ type: [ConversationMessageDto], description: 'Messages in a conversation' })
